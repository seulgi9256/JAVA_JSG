...
public class DateEx {
	public static void main(String[] args) throws ParseException {
		...
		Date date1 = new SimpleDateFormat("yyyy/MM/dd").parse(day1); // 문자열을 Date 객체로 변환
		Date date2 = new SimpleDateFormat("yyyy/MM/dd").parse(day2);

		// Date.getTime()
		// : 1970년 1월 1일 0시 0분 0초 부터 DATE에 지정된 날짜/시간 까지의 ms(밀리초) 누적값

...
public class Upcasting {
	...
	public static void main(String[] args) {
		...
		System.out.println("name : " + person.name); // 김조은
		System.out.println("age : " + person.age); // 20
...
//		System.out.println("major : " + person.major);
		...
		// 메소드는 자식 클래스의 메소드가 우선하여 실행한다.
		
		System.out.println( person );   // Student [grade=1, major=신재생에너지과]  -> toString

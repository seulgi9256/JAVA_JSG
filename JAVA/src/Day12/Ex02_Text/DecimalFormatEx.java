...
public class DecimalFormatEx {
	public static void main(String[] args) {
		...
		System.out.println( df.format(num)); // 1246
		
		df = new DecimalFormat("0.0");
		System.out.println( df.format(num)); // 1245.6
		
		df = new DecimalFormat("00000.00000"); // 01245.56780
		...
		df = new DecimalFormat("#####.#####"); // 1245.5678
		System.out.println( df.format(num));
		...
		// 천 단위 구분(,)
		df = new DecimalFormat("#,###");
		System.out.println( df.format(num2)); // 1,000,000

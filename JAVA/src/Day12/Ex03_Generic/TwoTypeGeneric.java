...
public class TwoTypeGeneric {
	...
	public static void main(String[] args) {
		...
		System.out.println("kv - key : " + kv.getKey()); // Java 
		System.out.println("kv - key : " + kv.getValue()); //100

		System.out.println("kv - key : " + kv2.getKey()); //100
		System.out.println("kv - key : " + kv2.getValue()); //Java

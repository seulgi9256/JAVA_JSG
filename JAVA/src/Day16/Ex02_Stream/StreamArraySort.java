...
//		Arrays.sort(arr);
//		System.out.println("기본 배열에 정렬");
//		for (int i : arr) {
//			System.out.print(i + " ");
//		}
//		System.out.println();
		
		int sortedArr[] = Arrays.stream(arr).sorted().toArray(); // Arrays.stream(arr).sorted() -> toArray.
		...
		Arrays.stream(arr).sorted().forEach( (n) -> System.out.print(n + " ") ); // 오름차순
